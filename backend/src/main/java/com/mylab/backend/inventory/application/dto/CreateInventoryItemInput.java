...
public record CreateInventoryItemInput(String name, String description, InventoryItemType itemType,
        InventoryUnitOfMeasure unitOfMeasure, BigDecimal referenceUnitValue) { }
